...
data "oci_core_vnic_attachments" "VM_VNIC1_attach" {
...
data "oci_core_vnic" "VM_VNIC1" {
  vnic_id = data.oci_core_vnic_attachments.VM_VNIC1_attach.vnic_attachments.0.vnic_id
}